...
public class UserProfileController {
    ...
    public SingleResult<UserDTO> findUserById(@ApiParam(value = "회원ID", required = true) @PathVariable("id") String id, @ApiParam(value = "언어", defaultValue = "ko") @RequestParam String lang) {
